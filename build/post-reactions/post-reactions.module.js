...
PostReactionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: post_reactions_schema_1.PostReactions.name, schema: post_reactions_schema_1.PostReactionsSchema }]),
            jwt_1.JwtModule,
        ],
        controllers: [post_reactions_controller_1.PostReactionsController],
        providers: [post_reactions_service_1.PostReactionsService],
    })
], PostReactionsModule);
