...
const skills_schema_1 = require("./schemas/skills.schema");
...
let SkillsService = class SkillsService {
    ...
    async update(id, updateSkillsDto) {
...
SkillsService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(skills_schema_1.Skills.name)),
